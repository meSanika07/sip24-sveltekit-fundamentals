...
<form class="container mx-auto p-5" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        <canvas id="imageCanvas" class="border border-gray-300 w-full h-64 mb-4"></canvas>
    </div>

    <div class="flex justify-center space-x-4 mb-3">
        <button type="button" class="bg-gray-200 text-gray-700 px-4 py-2 rounded" on:click={applyGrayscale}>Grayscale</button>
        <button type="button" class="bg-gray-200 text-gray-700 px-4 py-2 rounded" on:click={applySepia}>Sepia</button>
    </div>
